...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(2, "5f7edc8a798473aa1f8e301fb025dd29", "5d1cb9b979d6cc1343f2df6edbe2e3d8") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        ...
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `categories` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userId` INTEGER, `name` TEXT, `icon` TEXT, `color` TEXT, `system` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL)");
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `budgets` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userId` INTEGER NOT NULL, `categoryId` INTEGER NOT NULL, `limitAmount` INTEGER NOT NULL, `month` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL)");
        ...
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '5f7edc8a798473aa1f8e301fb025dd29')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        final Map<String, TableInfo.Column> _columnsCategories = new HashMap<String, TableInfo.Column>(8);
        ...
        final Map<String, TableInfo.Column> _columnsBudgets = new HashMap<String, TableInfo.Column>(7);
